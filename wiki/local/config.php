...
##  Be sure to take a look at http://www.pmwiki.org/wiki/Cookbook
##  for more details on the types of customizations that can be added
##  to PmWiki.

## Eliminate "pmwiki.php" from URLs.
$EnablePathInfo = 0;
$ScriptUrl = "http://localhost/flatland-wiki/";

##  $WikiTitle is the name that appears in the browser's title bar.
$WikiTitle = 'Flatland ARG!!! Wiki';
...
##  The following line adds target='_blank' to the HTML so that each external
##  link is opened in a new window. To disable this behavior for specific
##  links, use %target=_self% in front of the link to cause it to open in the
##  current window.
...
##  Set PmWiki's $GroupPattern variable to only accept the group names you want
##  to define.
$GroupPattern = '(?:Site|SiteAdmin|Main)'; # (case insensitive)
